...
//            }
    ...
    private void createIngredientsRU() {
        ...
        bufferIngredient.add(new Ingredient(10, "маринованные огурцы", R.drawable.ogur_mar, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(12, "лимонный сок", R.drawable.lemon_juice, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(13, "свиные", R.drawable.farsh_kur, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(14, "итальянские травы", R.drawable.tuna_kons, 0, 0));
